...
router.patch("/users/:id", auth, async function (req, res) {
    ...
    const allowedUpdates = ["fullname", "password", "phone", "gender", "dob", "activity", "height", "weight", "city", "targetWeight", "wholeInterval", "graphdata","last","calorieBurned"];
...
router.post("/forgot", async (req,res)=>{
    ...
    // })
        ...
        const link = `https://cc-nutrifit123.herokuapp.com/reset/${result[0]._id}/${token}`;
